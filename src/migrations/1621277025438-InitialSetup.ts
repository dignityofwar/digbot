...
export class InitialSetup1621277025438 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `messenger_role` (`id` int NOT NULL AUTO_INCREMENT, `guildId` varchar(255) NOT NULL, `roleId` varchar(255) NOT NULL, `channelId` varchar(255) NULL, `message` text NOT NULL, INDEX `IDX_97caf37cdb9f1b986ab2455bee` (`guildId`), INDEX `IDX_342907c0493b2eed02f185eeed` (`roleId`), UNIQUE INDEX `IDX_c4987f1129e9fef9a7424bc744` (`roleId`, `channelId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
